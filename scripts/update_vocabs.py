...
BASE_DB_URI = "http://fuseki.surroundaustralia.com/gsq-vocabs"
WEBSITE_URL = "http://gsq.surroundaustralia.com"
...
def get_graph_uri_for_vocab(vocab: Path) -> URIRef:
    ...
    have one and only one ConceptScheme per file and that the GA VocPrez installation uses the ConceptScheme URI
    as the Graph URI"""
